...
_uuid4(rng::AbstractRNG=Random.default_rng()) = uuid4(rng)
...
get_task_ctxvars(t = Base.current_task()) = t.ctxvars
set_task_ctxvars(t, ctx) = t.ctxvars = ctx
set_task_ctxvars(ctx) = set_task_ctxvars(Base.current_task(), ctx)
